    ...
    <Container className="xs:py-5 lg:!pb-10 xl:mt-7 ">
      <div className="bg-primary grid grid-cols-1 sm:grid-cols-9 sm:px-0 px-3 rounded-md">
        <div className="relative sm:col-span-5 md:col-span-4 sm:h-[320px] xsm:px-8 sm:px-0">
          <Image
            src="/assets/images/callus/callus.webp"
            fill
            loading="lazy"
          ...
          <div className="sm:absolute top-0 w-full h-full pt-8 sm:py-6 lg:py-8 sm:ps-8 sm:pe-14 2xl:pe-20 flex flex-col justify-center gap-4 items-center sm:items-start sm:justify-between">
            <h2 className="text-center sm:text-start text-primary-foreground text-24 sm:text-28 xl:text-[40px] font-semibold font-futura leading-tight lg:max-w-md">
              Ready to Decide? Let&apos;s Set It Up Instantly!
            </h2>
            <Link
              href="tel:042522025"
              target="_blank"
            ...
            >
              ...
              <div className="flex flex-col text-primary-foreground">
                <p className="text-md xl:text-xl font-medium font-futura">
                  Call Us Any Time
                </p>
                <p className="text-lg xl:text-2xl font-bold font-roboto">
                  04 252 2025
                </p>
              </div>
            </Link>
