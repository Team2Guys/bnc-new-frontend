      ...
      <div className="hidden sm:block">
        <div className="grid md:grid-cols-2 gap-6 lg:gap-16 items-center md:py-8 p-2">
          ...
          <div className={`relative w-full ${isHome ? "px-4  h-[235px] lg:h-[454px] object-cover":"h-[500px] lg:h-[547px] object-contain"}`}> 
            ...
            {
              isHome &&
            <div className="absolute bottom-10 -left-10 lg:bottom-32 xl:bottom-[73px] lg:-left-[80px] 2xl:-left-[10px] w-[116px] h-[56px] md:h-[70px] md:w-[140px] lg:h-[100px] lg:w-[200px] bg-primary flex flex-col items-center justify-center -rotate-90">
