      ...
      <Container>
         <div className='bg-primary sm:mt-0 mt-4 grid grid-cols-1 md:grid-cols-2 rounded-2xl overflow-hidden'>
            <div className='px-3 py-6 sm:p-6 lg:p-10 text-white flex flex-col gap-4 lg:gap-6 sm:justify-center items-start'>
               <h3 className='text-2xl xs:text-3xl lg:text-4xl font-futura font-extrabold'>Need Guidance?</h3>
               ...
               <Link href={`https://wa.me/${WhatsAppInfo.number.replaceAll(' ', '')}`} target='_blank' aria-label="Chat on WhatsApp" className='text-lg xs:text-2xl font-medium font-roboto bg-white w-48 xs:w-56 h-14 rounded-md flex gap-2 text-black justify-center items-center' ><Image width={100} height={100} className='size-6 xs:size-7' src='/assets/images/whatsapp.webp' alt='whatsapp'/> WhatsApp Us</Link>
            </div>
            <div className='sm:pt-5'>
              <Image src='/assets/images/callus/needhelp1.webp'
               fill
