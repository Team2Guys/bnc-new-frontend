    ...
    >
      <Container className=" flex items-center gap-2">
        ...
        {slug && (
          <>
            {arrow}
          <Link  href={slug === "Blinds"? "/made-to-measure-blinds/": slug === "curtains"? "/made-to-measure-curtains/" :slug === "commercial-window-coverings"? "/commercial/": slug === "shutters"? "/shutters-range/": `/${slug}`}
