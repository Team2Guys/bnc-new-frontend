...
const TestimonialCard = ({ testimonial }: { testimonial: IREVIEWS }) => {
    ...
    <div className="grid grid-cols-1 bg-transparent p-4 2xl:p-6 lg:mb-5 h-fit">
      ...
      <div className="mt-2">
        ...
        <div className="relative mt-2">
          <p
            ref={contentRef}
            className={`text-black font-roboto font-normal text-sm xsm:text-base overflow-hidden transition-all duration-700 ease-in-out ${
              isExpanded ? 'max-h-[1000px]' : 'max-h-[95px]'
            }`}
          >
            {testimonial.ReviewsDescription}
          </p>
