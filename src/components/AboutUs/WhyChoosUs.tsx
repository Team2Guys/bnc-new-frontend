  ...
  return (
    <>
      <section className="sm:py-16 mt-10 bg-white text-center">
        <h2 className="sm:text-4xl text-[27px] font-bold mb-2 font-futura text-primary">
          Why Choose Blinds and Curtains?
        </h2>
        <p className="text-primary text-base sm:mb-12 font-roboto font-normal">
          You just found the Industry&apos;s premier window treatment design
          team.
        </p>
          ...
          {whyChooseData.map((item: WhyChooseItem, index: number) => (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <h3
                  className="font-extrabold font-robotoSerif text-20 mb-2 text-primary"
                  dangerouslySetInnerHTML={{ __html: item.title }}
                />
                <p className="text-base font-roboto text-[#3E3F42]">
                  {item.description}
                </p>
              </div>
            </div>
