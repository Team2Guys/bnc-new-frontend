      ...
      <Container className="py-10 space-y-2 sm:space-y-4 lg:space-y-8 relative z-10">
        <div className="max-w-[520px] space-y-2 sm:space-y-4 lg:space-y-8 ">
          ...
          <p className="text-base lg:text-2xl text-white font-roboto drop-shadow-2xl">
            In Motorised {path.includes('curtains') ? 'curtains' : 'blinds'}, we
            offer customisation with a range of fabrics, hardware colours, and
            charging options.
          </p>
        </div>
        <div className="space-y-3">
          <p className="max-w-[660px] font-futura font-extrabold text-19 sm:text-3xl lg:text-[40px] text-white drop-shadow-2xl">
            ...
            <span className="block sm:hidden">
              of automated{' '}
              {title === 'Motorised blinds' ? 'blinds' : 'curtains'}
            </span>
          </p>
        ...
        <div className=" pt-5">
          <Link
            ...
            className="bg-secondary hover:opacity-65 text-primary rounded-md py-2 sm:py-4 px-4 sm:px-8 font-roboto font-semibold block w-fit"
          >
            Book A Free Visit
          </Link>
        </div>
