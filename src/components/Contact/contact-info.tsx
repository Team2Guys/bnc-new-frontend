...
const ContactInfo = () => {
  return (
    <div className="bg-black rounded-lg p-4 xs:p-6 text-white space-y-4 order-2 md:order-1">
      <h2 className="font-futura font-medium text-2xl">Tell Us More</h2>
      <p className="text-base md:text-lg">
        The most trusted window treatment company in Dubai with a decade of
        experience and 100s of positive reviews.
      </p>
      <div>
        ...
        <div className="flex flex-col gap-4 lg:mt-6 mt-4">
          <div className="flex gap-2">
            ...
            <Link
              href="https://maps.app.goo.gl/vNTgPQs3TQnwipvs5"
              target="_blank"
              className="max-w-80 w-full text-xl font-roboto hover:underline"
            >
