    ...
    >
      {({ values, setFieldValue }) => (
        <Form className="grid grid-cols-1 sm:grid-cols-2 gap-4 order-1 md:order-2">
          ...
          />
          <div>
            <label htmlFor="phone" className="primary-label">
              Phone*
            </label>
            <PhoneInput
            ...
            />
            <div
              className="flex items-center gap-2 cursor-pointer mt-3 w-fit"
              onClick={() => {
            ...
            >
              <div
                className={`size-4 sm:size-5 flex items-center justify-center rounded-full border ${sameAsPhone ? 'bg-primary text-white' : 'border-primary text-priborder-primary'}`}
              >
                {sameAsPhone && (
