    ...
    <div className='bg-secondary-foreground py-4 md:py-0'>
        <Container className='grid grid-cols-12 md:gap-4 items-center' >
           <div className=' col-span-12 md:col-span-8 space-y-3 order-2 md:order-1 text-primary'>
            ...
            <p className='font-normal font-roboto text-16 pb-1 xs:pb-6'>{Data?.description}</p>
           ...
           <div className='col-span-12 md:col-span-4 order-1 md:order-2'>
            ...
            <Image src={Data.posterImage?.imageUrl || ""} className='rounded-md xs:rounded-xl' fetchPriority='high' priority fill alt={Data.title} sizes='40vw' />
            </div>
           </div>
        </Container>
    </div>
