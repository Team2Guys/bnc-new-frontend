    ...
    <>
      ...
      <div className="px-4 py-10 max-w-7xl mx-auto text-center ">
        ...
        <p className="sm:text-3xl text-2xl mb-2">
          One of our sales team will be in touch shortly to confirm the details.
          If you’re in a hurry, drop us a message on{' '}
          <Link
            href="https://wa.me/0544945339"
            className="font-bold underline ml-1 text-secondary"
          >
            054 494 5339
          </Link>{' '}
          or call{' '}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 sm:gap-6 bg-white border shadow-xl mt-10">
          {thankYouCards.map((card, index) => (
            <div key={index} className="text-center sm:p-12 p-6 ">
              ...
              <p className="text-base mt-4 sm:h-24 sm:pb-0 pb-4">
                {card.description}
              </p>
