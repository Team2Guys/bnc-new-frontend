...
import { Description1, Description2, sliderImages1, sliderImages2 } from 'data/choose.us';
import Image from 'next/image';
export const metadata = generateMetadata(metaData.why_choose);
const ChooseUs = () => {
  return (
    <>
    <Breadcrumb image="/assets/images/about-us/aboutusherobanner.webp" title="Why Choose Us"/>
    <Container className='mt-5 lg:mt-10 space-y-4'>
      <h2 className='font-semibold text-3xl md:text-4xl text-primary font-futura text-center hidden sm:block pb-4'>Why Choose Blinds & Curtains</h2>
      <WhyChoose 
    ...
    <h2 className='font-semibold text-2xl md:text-4xl text-primary font-futura text-center'>Location</h2>
