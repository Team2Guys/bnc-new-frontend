...
const EstimatorPage = ({
  ...
  sortedProducts: EstimatorProductTypes[];
}) => {
  const [selectedProduct, setSelectedProduct] =
    useState<EstimatorProductTypes | null>(null);
  const [activeProduct, setActiveProduct] =
    useState<EstimatorProductTypes | null>(sortedProducts[0]);
  ...
  const calculatePrice = (width: number | '', height: number | '') => {
    if (
      activeProduct?.title === 'Sheer Curtains' ||
      activeProduct?.title === 'Blackout Curtains'
    ) {
        ...
        <div className="grid grid-cols-12 gap-4 lg:gap-10 xl:gap-14 md:px-2 xl:px-0">
          <div className="col-span-12 md:col-span-6 mt-2 sm:mt-0">
            <div className="w-full h-[350px] xs:h-[600px] md:h-[450px] xl:h-[620px] relative">
              <Image
                src={
                  selectedProduct?.posterImage?.imageUrl ||
                  sortedProducts[0].posterImage.imageUrl
                }
          ...
          <div className="flex flex-col space-y-3 col-span-12 md:col-span-6 px-2 md:px-0">
            <div className="max-w-[520px] pb-2">
              ...
              <ul className="list-disc pl-5 pt-3 text-sm sm:text-base">
                <li>
                  Price is an estimate; final cost depends on exact size and
                  fabric.
                </li>
                <li>
                  Final quote confirmed during your free visit, no hidden
                  charges.
                </li>
                <li>
                  Estimator prices for blinds, curtains, and shutters start at
                  1.5m².
                </li>
              </ul>
            </div>
            <div className="space-y-3 border-t pt-6 max-w-[520px]">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className=" text-sm">Enter Size</span>
                </div>
              </div>
              <UnitSelector
