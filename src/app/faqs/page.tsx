...
const FAQPage = () => {
  return (
    <div>
      <Breadcrumb
        image="/assets/images/Home/faqsbanner.webp"
        title="Frequently Asked Questions About Blinds and Curtains Dubai"
        bradcrumbtitle="Frequently Asked Questions"
      />
      <Container>
        <div className="flex justify-center items-center">
          <h2
            className="font-roboto font-normal text-sm md:text-xl text-center my-5 sm:my-7 text-primary md:max-w-screen-lg "
