export const metaData = {
  ...
  blog: {
    ...
    description:"Read our blog for the latest updates on trends and new products. Get to know the best product for your home or business. For more information, give us a call.",
    path: "/blog/",
  },
  contact: {
  ...
  estimator: {
    ...
    description:"Find the perfect blinds & curtains for your home in Dubai with our easy price calculator. Get instant estimates & design your dream space effortlessly.",
    path: "/estimator/",
  },
  gallery: {
    title:"Blinds And Curtains Dubai | Gallery Section",
    description:"Explore our gallery section, which includes all the products and different designs for you to select easily. Available in a variety of designs to suit your space.",
    path: "/gallery/",
  },
  product_guarantees: {
  ...
  why_choose: {
    ...
    path: "/why-choose-blinds-curtains/",
  },
  faqs: {
    title:"Custom Blinds & Curtains Dubai | Free Home Visit | Fast Service",
    description:"Find answers to all your questions about our curtains, blinds, and shutters in Dubai. From showroom visits to product installation, pricing, and refunds.",
    path: "/faqs/",
  },
};